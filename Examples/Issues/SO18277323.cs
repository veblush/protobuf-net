    ...
    public class SO18277323
    {
        ...
        public void ExecuteSimple()
        {
            using (var ms = new MemoryStream())
            {
                ...
                Assert.Equal("1A-13-0A-11-0A-03-61-62-63-12-0A-0A-03-64-65-66-12-03-67-68-69-08-01-12-02-6F-6B", BitConverter.ToString(ms.ToArray(), 0, (int)ms.Length));
                ms.Position = 0;
        ...
        public void ExecuteCustom()
        {
            using (var ms = new MemoryStream())
            {
                ...
                Assert.Equal("1B-0B-0A-03-61-62-63-13-0A-03-64-65-66-12-03-67-68-69-14-0C-1C-08-01-12-02-6F-6B", BitConverter.ToString(ms.ToArray(), 0, (int)ms.Length));
                ms.Position = 0;
